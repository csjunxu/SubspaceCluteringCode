...
\end{split}
\end{equation}
This model can also be solved by the ADMM algorithm similar to previous sections. We ignore the detail steps and only introduce the major updating steps as follows:
...
\end{split}
\end{equation}
This is a standard non-negative least squares (NNLS) problem which can be solved by the Lawson and Hanson algorithm \cite{lawsonhanson}.
