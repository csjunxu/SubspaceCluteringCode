...
\frac{\rho}{2}
\|
\bm{E}_{k}-\bm{X}+\bm{X}\bm{C}+\rho^{-1}\bm{\Delta}_{k}
\|_{F}^{2}
\\
&
+
...
\end{split}
\end{equation}
where $\bm{P}_{k}=\bm{X}-\bm{E}_{k}-\rho^{-1}\bm{\Delta}_{k}$
and
$\bm{Q}_{k}=\bm{A}_{k+1}-\rho^{-1}\bm{\delta}_{k}$.
...
\frac{1}{2}
\|
(\bm{X}-\bm{X}\bm{C}_{k+1}-\rho^{-1}\bm{\Delta}_{k})
-
\bm{E}
\|_{F}^{2}
+
